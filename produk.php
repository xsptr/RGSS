...
<head>
    ...
    <title>Produk</title>
	 <link href='img/RGSS5.ico' rel='img/RGSS5.ico'>
    <!-- Bootstrap Style -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php else: ?>
                    <li>
                        <a href="index.php#login" data-toggle="modal"><i class="fa fa-user"></i> Login</a>
                    </li>
                    <?php endif ?>
                    <li>
    ...
    <div class="container">
       <div class="row">
        ...
        <div class="row">
          <?php
          //get rows query
          $query = $db->query("SELECT * FROM products ORDER BY id DESC LIMIT 10"); // Ambil data dari database
          if($query->num_rows > 0){
              while($row = $query->fetch_assoc()){
          ?>

            <div class="col-xs-12 col-sm-6 col-md-3 pad-top">
             <div class="col-item">
                <div class="post-img-content photo">
                    <img src="<?php echo "admin/images/". $row["image"]; ?>" class="img-responsive" /> <!-- Tampilkan gambar dari kolom image dari tabel products berdasarkan letak folder -->
                </div>
                <div class="info">
                    <div class="row">
                        <div class="price col-md-12">
                            <h5><?php echo $row["name"];?></h5> <!-- Tampilkan kolom nama dari tabel products -->
                            <h5 class="price-text-color">Rp. <?php echo $row["price"];?></h5> <!-- Tampilkan kolom harga dari tabel products -->
                        </div>
                    </div>
                        <?php if (!isset($_SESSION['nama'])): ?>
                            <?php echo
