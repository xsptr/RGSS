...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href='admin/ordered.php'>Barang yang dipesan</a>
                    </li>"
                         ?>
                    <?php else: ?>
                    <li>
     ...
     <!-- Order Section -->
    <section class="success" id="order">
        <div class="container">
            <div class="row">
            ...
            <div>
            </br>Berikut merupakan TATA CARA PEMESANAN di toko kami :
</br> 1. Untuk melakukan pemesanan dapat dilakukan melalui pengiriman pesan ke NO.HP(WA) dan BBM, dengan format 
    </br> Nama                      :
    </br> Alamat Lengkap                :
    </br> No.Telp                       :
    </br> Kode Barang/Jumlah Barang : 
    </br> Nama Barang                   :   
</br> 2. Setelah itu anda akan mendapatkan pesan balasan dari toko kami berupa TOTAL HARGA (JUMLAH_HARGA_BARANG+ONGKOS KIRIM)
</br> 3. Setelah itu anda bisa transfer ke rek xxxxxxxxxxxx
</br> 4. Kemudian kirim bukti pembayaran ke WA atau BBM kami
</br> 5. Tunggu konfirmasi dari kami
</br> Jasa Pengiriman Yang Kami Gunakan Adalah JNE
            </div>
        </div>
    </section>
   <!-- Footer -->
